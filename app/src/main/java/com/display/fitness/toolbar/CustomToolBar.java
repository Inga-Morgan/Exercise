package com.display.fitness.toolbar;
...
import static com.display.fitness.utils.CommonExtKt.dp2px;
...
public class CustomToolBar extends Toolbar {
    ...
    public CustomToolBar setLeftIcon(Drawable drawable) {
        ...
        if (this.mLeftIcon == null) {
            ...
            //保持点击区域
            int padding = (int) this.getContext().getResources().getDimension(R.dimen.dp_16);
    ...
    public void setMySettingText(CharSequence text) {
        ...
        mSettingText.setTextColor(getResources().getColor(R.color.white));
